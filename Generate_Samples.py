...
# Ckalraborty et al. (202)
# attribute 'german' has been modified to match the dataset for the thesis
# and a seed is set
...
def generate_samples(no_of_samples,df,df_name,colum):
    ...
    final_df = pd.DataFrame(total_data, columns=colum)
    if df_name == 'Adult':
    ...
    if df_name == 'German':
    	final_df = final_df.rename(columns={0:"existingchecking",1:"sex",2:"maritalStatus", 3:"duration", 4:"credithistory", 5:"purpose", 6:"creditamount", 7:"savings", 8:"employmentsince", 9:"installmentrate", 10:"otherdebtors", 11:"residencesince", 12:"property", 13:"age", 14:"otherinstallmentplans", 15:"housing", 16:"existingcredits", 17:"job", 18:"peopleliable", 19:"telephone", 20:"foreignworker", 21:"classification"}, errors="raise")
    if df_name == 'Heart':
    ...
    if df_name == 'None':
        final_df = pd.DataFrame(final_df, columns=colum)
